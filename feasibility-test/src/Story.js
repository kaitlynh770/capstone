...
import AOS from 'aos';
import process from './img/fast-process.mp4';
    ...
    return(
        <div className = 'container'>
            ...
            <h2 data-aos = "fade-left" data-aos-duration = "1500" data-aos-delay = "1500" className='left-float-heading' style = {boldFont}>recycled materials</h2>
                <p data-aos = "fade-down" data-aos-duration = "1500" data-aos-delay = "3000" className = 'about-paragraph'>A sustainable and elegant piece of clothing produced by deploying various engineering techniques. Plastifashion aims to do something rarely seen in the fashion industry: create high-end clothing out of recycled materials. With our dedication to the environment and a desire to make an impact in the world of high-fashion, Plastifashion is sure to shine a new light on recyclable materials.</p>
            </div>
            <div className = 'right-half'>
                <video className = 'pic-adjustments-story' data-aos = "fade-up" data-aos-duration = "1500" data-aos-delay = "3000" src = {process} autoPlay = {true} muted={true} loop = {true} />
